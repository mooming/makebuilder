...
public:
	...
	[[nodiscard]] auto GetBuildType() const
	{
		return buildType;
	}

	[[nodiscard]] auto IsIncludePath() const
	{
		return isIncludePath;
	}

	[[nodiscard]] auto& GetSourceFiles() const
	{
		return srcFiles;
	}

	[[nodiscard]] auto& GetObjectiveCSourceFiles() const
	{
		return objectiveCSrcFiles;
	}

	[[nodiscard]] auto& GetHeaderFiles() const
	{
		return headerFiles;
	}

	[[nodiscard]] auto& GetSubModules()
	{
		return submodules;
	}

	[[nodiscard]] auto& GetSubModules() const
	{
		return submodules;
	}
	...
	[[nodiscard]] auto& GetLibraries() const
	{
		return libraries;
	}

	[[nodiscard]] auto& GetLinkDirectories() const
	{
		return linkDirectories;
	}

	[[nodiscard]] auto& GetFrameworks() const
	{
		return frameworks;
	}

	[[nodiscard]] auto& GetCustomCMake() const
	{
		return customCMake;
	}

	[[nodiscard]] auto& GetIncludePaths() const
	{
		return includePaths;
	}

	[[nodiscard]] auto& GetPrecompileDefinitions() const
	{
		return precompileDefinitions;
	}

	[[nodiscard]] auto& GetOptimizeLevel() const
	{
		return optimizeLevel;
	}

	[[nodiscard]] auto& GetIgnoredSubdirectories() const
	{
		return ignoredSubdirectories;
	}

	[[nodiscard]] auto& GetLinkerGroupDependencies() const
	{
		return linkerGroupDependencies;
	}
